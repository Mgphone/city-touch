          ...
          <div className="flex flex-col justify-between text-left max-w-full">
            <div className="pb-6">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground mt-4 leading-relaxed">
                ...
                the market. We’re confident that we can match or beat any quote
                from other companies without compromising on service.
                <br />
                <br />
                Our mission is simple: <strong>make our customers happy</strong>
                . Whether you're moving across the street or across the city,
                our friendly, reliable team ensures a smooth and stress-free
